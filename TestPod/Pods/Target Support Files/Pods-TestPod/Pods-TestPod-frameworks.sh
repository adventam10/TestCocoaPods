...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AMBurnAnimation/AMBurnAnimation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AMCalendar/AMCalendar.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AMChart/AMChart.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AMClockView/AMClockView.framework"
